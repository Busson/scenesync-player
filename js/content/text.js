...
function MText(id_p,src_p,left_p,top_p,fontSize_p,fontFamily_p,color_p,weight_p,style_p,opacity_p){
    ...
    var left = left_p;
    var top = top_p;
    var fontSize = fontSize_p;
    var fontFamily = fontFamily_p;
    var color = color_p;
    ...
    var left_o = left_p;
    var top_o = top_p;
    var fontSize_o = fontSize_p;
    var fontFamily_o = fontFamily_p;
    var color_o = color_p;
    var weight_o = weight_p;
    var style_o = style_p;
    ...
    this.ApplyProperty = function(property_p){
        for(prl=0; prl < property_p.length; prl++){
            ...
            else if(property_p[prl].GetName()=="font-size")fontSize=property_p[prl].GetValue();
            else if(property_p[prl].GetName()=="font-family")fontFamily=property_p[prl].GetValue();
            else if(property_p[prl].GetName()=="color")color=property_p[prl].GetValue();
            else if(property_p[prl].GetName()=="font-weight")weight=property_p[prl].GetValue();
            else if(property_p[prl].GetName()=="font-style")style=property_p[prl].GetValue();
   ...
   /*     content = new Image();
    ...
    this.Draw = function (canvas) {
     ...
     //   console.log("media: "+id+" Começou em: "+relativeTime);
         ...
         canvas.font = style+" "+weight+" "+fontSize+" "+fontFamily;
         canvas.fillStyle = color;
         canvas.fillText(content, SS_CORE.GetCanvasWidth()*left, SS_CORE.GetCanvasHeight()*top);
